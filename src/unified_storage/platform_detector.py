...
# FAISS availability check - required for vector similarity search
# FAISS is the core search engine for the recognition system
# Without it, search functionality is severely limited
try:
    import faiss
    FAISS_AVAILABLE = True
except ImportError:
    FAISS_AVAILABLE = False
    logging.warning("FAISS not available - search functionality will be limited")
